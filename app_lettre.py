...
# Forcer l'utilisation de l'API v1 stable pour éviter l'erreur v1beta
options = client_options.ClientOptions(api_endpoint="generativelanguage.googleapis.com:443")
