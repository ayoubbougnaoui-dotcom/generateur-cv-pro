...
OPENAI_API_KEY = "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" 
...
if bloque_par_paywall:
    ...
    if st.button("🚀 Générer ma Lettre de Motivation Personnalisée"):
        if not poste_vise or not competences_cles or not offre_emploi:
            ...
            st.error("❌ Configuration requise : Clé API OpenAI manquante.")
        else:
